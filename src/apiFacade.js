...
const login = (user, password) => {
    ...
    fetchAny(`auth/login`, (data)=>setToken(data.token), (err)=>console.log(err), "POST", {username: user, password: password }, false);
}
async function fetchAny(url, handleData, handleError, method, body, withToken) {
